...
export default function App() {
  ...
  const artisansSecRef = useRef(null);
  const artisansLeftRef = useRef(null);
  const artisansRightRef = useRef(null);
  ...
  useEffect(() => {
    if (window.gsap && window.ScrollTrigger) {
      ...
      // SCENE 06: THE ARTISANS — ELEGANT STAGGERED EDITORIAL ENTRANCE (LEFT TEXT + PILLARS + IMAGE)
      if (artisansSecRef.current) {
        const artisanTl = window.gsap.timeline({
          scrollTrigger: {
            trigger: artisansSecRef.current,
            start: "top 78%",
          }
        });

        // 1. Eyebrow, Title & Paragraph
        artisanTl.fromTo(
          ".artisan-intro",
          { opacity: 0, y: 35, filter: "blur(4px)" },
          { opacity: 1, y: 0, filter: "blur(0px)", duration: 0.8, ease: "power3.out" }
        )
        // 2. Pillars staggered entrance from left
        .fromTo(
          ".artisan-pillar-item",
          { opacity: 0, x: -30, filter: "blur(2px)" },
          { opacity: 1, x: 0, filter: "blur(0px)", duration: 0.65, stagger: 0.14, ease: "power2.out" },
          "-=0.4"
        )
        // 3. CTA Button
        .fromTo(
        ...
        // 4. Right Team Photo Frame unfolding
        .fromTo(
          artisansRightRef.current,
  ...
  // DYNAMIC STAGGERED RANDOMIZED ENTRANCE ANIMATION ON FILTER SWITCH
  useEffect(() => {
  ...
  const socialReels = [
    {
      ...
      video: '/video1.mp4',
      tag: 'TRENDING CUT',
      caption: 'Signature Akhada scissor flow with Japanese shears ✂️ #thehairavenue #kolhapur',
      likes: '3.4K',
      comments: '88',
      audio: 'The Hair Avenue · Original Audio',
      views: '42.8K'
    },
    {
      id: 'reel2',
      ...
      caption: 'Gold Balayage gloss infusion on bridal curls ✨💎 #balayage #hairtransformation',
      likes: '5.9K',
      comments: '142',
      audio: 'Trending Audio · Luxury Salon Vibes',
      views: '78.2K'
    },
    {
      id: 'reel3',
      video: '/video3.mp4',
      tag: 'BEARD ARCHITECTURE',
      caption: 'Sharp razor taper & hot eucalyptus towel ritual 🔥 #beardsculpt #grooming',
      likes: '4.1K',
      comments: '96',
      audio: 'Barber Beats · Kolhapur Artisans',
      views: '54.6K'
    },
    {
      id: 'reel4',
      video: '/video4.mp4',
      tag: 'GLAM & HYDRA',
      caption: 'Pure glass skin hydra-facial & glow finish 🧖‍♀️✨ #hydrafacial #skincare',
      likes: '6.7K',
      comments: '204',
      audio: 'Salon Ambient · Relaxation Wave',
      views: '91.3K'
    }
  ];
  ...
  return (
    <div className="relative min-h-screen bg-[#070706] text-[#f5f2eb] overflow-x-hidden">
      ...
      <main className="pb-16 sm:pb-0">
        ...
        <section ref={unisexSceneRef} className="relative z-10 py-16 sm:py-28 px-4 sm:px-10 lg:px-16 bg-[#090807] border-t border-[#1f1e1a]">
          <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
              ...
              <div 
                ref={unisexMaleRef}
                className="group relative h-[480px] sm:h-[620px] lg:h-[700px] overflow-hidden border border-[#252420] bg-[#12110f] shadow-2xl"
              >
                <img 
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#070706] via-[#070706]/20 to-transparent"></div>
                ...
                <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                  <div className="space-y-1">
                    ...
                    <h3 className="font-display text-xl sm:text-2xl text-[#f5f2eb] font-normal">
                      Gentlemen's Couture
                    </h3>
                  </div>
        ...
        {/* SCENE 04: THE MENU (COMPACT BENTO GRID FITTING ONE FRAME) */}
          ...
          <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[#1f1e1a] pb-4 sm:pb-5">
              <div>
                ...
                <h2 ref={craftTitleRef} className="font-display text-2xl sm:text-4xl lg:text-5xl font-normal text-[#f5f2eb] tracking-tight">
                  The Menu
                </h2>
              ...
              {/* Filter Pills */}
              <div ref={servicesTabsRef} className="flex items-center gap-2 overflow-x-auto no-scrollbar pb-1">
            ...
            <div ref={craftGridRef} className="grid grid-cols-1 md:grid-cols-12 gap-3 sm:gap-4 lg:gap-5">
              ...
              <div className="md:col-span-4 flex flex-col gap-3 sm:gap-4 lg:gap-5">
                ...
                <div
                  onClick={() => {
                    setBookingData({ ...bookingData, service: 'Signature Cut & Style' });
                    setBookingConfirmed(false);
                    setBookingOpen(true);
                  }}
                  style={{ transitionDelay: selectedCategory !== 'All' ? '100ms' : '0ms' }}
                ...
                <div
                  onClick={() => {
                    setBookingData({ ...bookingData, service: 'Gold Balayage & Colour Restoration' });
                    setBookingConfirmed(false);
                    setBookingOpen(true);
                  }}
                  style={{ transitionDelay: selectedCategory !== 'All' ? '260ms' : '0ms' }}
                ...
                >
                  ...
                  <div className="relative z-10 space-y-1.5">
                    ...
                    <p className="text-[11px] sm:text-xs text-[#9c978e] font-body leading-relaxed line-clamp-1">
                      High-shine keratin colour lock with diamond infusion.
                    </p>
              ...
              <div className="md:col-span-8 flex flex-col gap-3 sm:gap-4 lg:gap-5">
                ...
                <div
                  onClick={() => {
                    setBookingData({ ...bookingData, service: 'The Akhada Sculpt' });
                    setBookingConfirmed(false);
                    setBookingOpen(true);
                  }}
                  style={{ transitionDelay: selectedCategory !== 'All' ? '40ms' : '0ms' }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-5">
                  ...
                  <div
                    onClick={() => {
                      setBookingData({ ...bookingData, service: 'Global Colour & Gloss' });
                      setBookingConfirmed(false);
                      setBookingOpen(true);
                    }}
                    style={{ transitionDelay: selectedCategory !== 'All' ? '300ms' : '0ms' }}
                  ...
                  >
                    <img
                      src="/GlobalColour.jpeg"
                      alt="Global Colour & Gloss"
                      className={`absolute inset-0 w-full h-full object-cover transition-all duration-700 ease-out ${getImageFilterClass('Hair')}`}
                    />
                  ...
                  <div
                    onClick={() => {
                      setBookingData({ ...bookingData, service: 'Precision Beard Sculpt' });
                      setBookingConfirmed(false);
                      setBookingOpen(true);
                    }}
                    style={{ transitionDelay: selectedCategory !== 'All' ? '160ms' : '0ms' }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 sm:gap-4 lg:gap-5">
                  ...
                  <div
                    onClick={() => {
                      setBookingData({ ...bookingData, service: 'Hydra Facial' });
                      setBookingConfirmed(false);
                      setBookingOpen(true);
                    }}
                    style={{ transitionDelay: selectedCategory !== 'All' ? '80ms' : '0ms' }}
                  ...
                  <div
                    onClick={() => {
                      setBookingData({ ...bookingData, service: 'Bridal Hair & Makeup' });
                      setBookingConfirmed(false);
                      setBookingOpen(true);
                    }}
                    style={{ transitionDelay: selectedCategory !== 'All' ? '220ms' : '0ms' }}
        ...
        <section id="scene-artisans" ref={artisansSecRef} className="relative z-10 py-20 sm:py-32 px-4 sm:px-12 lg:px-20 bg-[#0e0e0c] border-t border-[#1f1e1a]">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-16 items-center">
              
              {/* LEFT COLUMN: INFO & STORYTELLING */}
              <div ref={artisansLeftRef} className="lg:col-span-6 space-y-6 sm:space-y-8">
              ...
              <div ref={artisansRightRef} className="lg:col-span-6">
                <div className="relative aspect-[4/3] sm:aspect-[16/11] overflow-hidden bg-[#141412] border border-[#252420] shadow-2xl cursor-pointer" onClick={() => { setBookingConfirmed(false); setBookingOpen(true); }}>
                  <img
        ...
        {/* SCENE 07: SOCIAL MEDIA · INSTAGRAM REELS (4 VIDEO CARDS) */}
        <section id="social" className="relative z-10 py-16 sm:py-24 lg:py-28 px-4 sm:px-8 lg:px-14 bg-[#070706] border-t border-[#1f1e1a]">
          <div className="max-w-7xl mx-auto space-y-8 sm:space-y-10">
            
            {/* Header with Instagram Title & Direct Follow Button */}
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-[#1f1e1a] pb-5">
              <div className="timeline-header">
                <span className="text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.35em] text-[#cbb074] font-body block mb-1">
                  Scene 07 · Social Atelier
                </span>
                <h2 className="font-display text-2xl sm:text-4xl lg:text-5xl font-normal text-[#f5f2eb] tracking-tight">
                  As Seen On Instagram
                </h2>
                <p className="mt-1 text-xs sm:text-sm text-[#9c978e] font-body">
                  Real sittings. Real transformations. Live from our Dabholkar Corner atelier.
                </p>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#161412] border border-[#cbb074]/40 hover:border-[#cbb074] text-[#f5f2eb] hover:text-[#cbb074] text-[11px] font-body uppercase tracking-[0.15em] transition-all self-start sm:self-auto shadow-lg group"
              >
                <span className="w-2 h-2 rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] inline-block animate-pulse"></span>
                <span>Follow @thehairavenue</span>
                <span className="group-hover:translate-x-0.5 transition-transform">↗</span>
              </a>
            </div>

            {/* 4 INSTAGRAM REEL CARDS GRID */}
            <div ref={timelineGridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {socialReels.map((reel) => (
                <div
                  key={reel.id}
                  onClick={() => {
                    setBookingData({ ...bookingData, service: reel.tag });
                    setBookingConfirmed(false);
                    setBookingOpen(true);
                  }}
                  className="group relative h-[450px] sm:h-[490px] rounded-3xl overflow-hidden bg-[#0d0c0a] border border-white/10 hover:border-[#cbb074] transition-all duration-500 shadow-2xl cursor-pointer flex flex-col justify-between p-4 sm:p-5 select-none hover:shadow-[0_10px_35px_rgba(203,176,116,0.2)]"
                >
                  {/* Background Video */}
                  <video
                    src={reel.video}
                    ...
                    muted
                    playsInline
                    className="absolute inset-0 w-full h-full object-cover filter contrast-105 brightness-90 group-hover:scale-105 group-hover:brightness-100 transition-all duration-700 pointer-events-none"
                  />
                  
                  {/* Gradient Overlays */}
                  <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-transparent to-black/90 pointer-events-none"></div>

                  {/* TOP REEL HEADER OVERLAY */}
                  <div className="relative z-10 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-8 h-8 rounded-full p-[1.5px] bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] shadow-md">
                        <div className="w-full h-full rounded-full bg-[#070706] flex items-center justify-center text-[10px] font-bold text-[#cbb074]">
                          HA
                        </div>
                      </div>
                      <div className="leading-tight">
                        <span className="text-[11px] font-semibold text-white font-body flex items-center gap-1 drop-shadow">
                          thehairavenue
                          <svg className="w-3 h-3 text-[#3897f0] inline" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                          </svg>
                        </span>
                        <span className="text-[9px] text-[#d4cfc7] block font-body opacity-90 drop-shadow">Kolhapur</span>
                      </div>
                    </div>

                    {/* Reel Icon Badge */}
                    <div className="flex items-center gap-1 bg-black/60 backdrop-blur-md px-2.5 py-1 rounded-full border border-white/15 text-[10px] text-[#f5f2eb] font-body">
                      <span className="text-[#cbb074] text-xs">▶</span>
                      <span className="text-[9px] uppercase tracking-wider font-semibold">Reel</span>
                    </div>
                  </div>

                  {/* FLOATING RIGHT ACTION SIDEBAR */}
                  <div className="absolute right-3.5 bottom-24 z-10 flex flex-col items-center gap-3.5 text-white drop-shadow-md">
                    {/* Like Button */}
                    <div className="flex flex-col items-center gap-0.5">
                      <div className="w-9 h-9 rounded-full bg-black/50 backdrop-blur-md flex items-center justify-center border border-white/15 group-hover:border-[#cbb074]/60 group-hover:scale-110 transition-all text-red-500">
                        ♥
                      </div>
                      <span className="text-[10px] font-semibold font-body">{reel.likes}</span>
                    </div>

                    {/* Comment Button */}
                    <div className="flex flex-col items-center gap-0.5">
                      <div className="w-9 h-9 rounded-full bg-black/50 backdrop-blur-md flex items-center justify-center border border-white/15 group-hover:border-[#cbb074]/60 group-hover:scale-110 transition-all text-xs">
                        💬
                      </div>
                      <span className="text-[10px] font-semibold font-body">{reel.comments}</span>
                    </div>
                  ...
                  <div className="relative z-10 pr-12 space-y-1.5">
                    <span className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#070706] bg-[#cbb074] px-2 py-0.5 rounded-full inline-block shadow-sm">
                      {reel.tag}
                    </span>

                    <p className="text-[11px] sm:text-xs text-[#f5f2eb] font-body leading-snug line-clamp-2 drop-shadow">
                      {reel.caption}
                    </p>

                    <div className="flex items-center gap-1.5 text-[10px] text-[#cbb074] font-body pt-0.5">
                      <span className="animate-pulse">♫</span>
                      <span className="truncate text-[#d4cfc7] text-[10px]">{reel.audio}</span>
                    </div>
                  </div>
            ...
            <div className="pt-2 text-center">
              <p className="text-xs sm:text-sm text-[#9c978e] font-display italic tracking-wide">
                Tag <span className="text-[#cbb074] font-semibold not-italic">#TheHairAvenue</span> to get featured on our live studio feed.
              </p>
            </div>
        ...
        <section id="scene-devanagari" className="relative z-10 py-20 sm:py-32 px-4 sm:px-12 lg:px-20 bg-[#0e0e0c] border-t border-[#1f1e1a] text-center">
          <div ref={devanagariCardRef} className="max-w-4xl mx-auto space-y-6 sm:space-y-8 will-change-transform">
            ...
            <div className="flex items-center justify-center py-2">
              <h3 className="font-devanagari text-3xl sm:text-5xl lg:text-6xl font-normal text-[#f5f2eb] hover:text-[#cbb074] transition-colors duration-500 tracking-wide leading-tight">
                तुमची शैली. तुमची ओळख.
              </h3>
            </div>
            <blockquote className="font-display text-lg sm:text-3xl text-[#9c978e] font-normal italic px-2">“Born in Kolhapur. Designed for everywhere.”</blockquote>
          </div>
        </section>
